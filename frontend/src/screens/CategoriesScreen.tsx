    ...
    const renderCategory = ({ item }: {item: any}) =>(
        <View style={categoriesStyles.categoryCard}> 
            ...
            <View style={categoriesStyles.actionsContainer}>  
                ...
                <TouchableOpacity style={[categoriesStyles.actionButton, categoriesStyles.editButton]}
                ...
                style={[categoriesStyles.actionButton, item.active ? categoriesStyles.deleteButton : categoriesStyles.editButton
                    ...
                    <Text style={[categoriesStyles.actionButtonText, item.active ? categoriesStyles.deleteButtonText :
                        categoriesStyles.editButtonText
                    ]}>
        ...
        <View style={categoriesStyles.container}>
            <View style={categoriesStyles.header}>
                <View style={categoriesStyles.headerContent}>
                    <Text style={categoriesStyles.headerTitle}> Gestiones de Categorias</Text>
                    <TouchableOpacity style={categoriesStyles.addButton} onPress={() => {
                        resetForm();
                        setModalVisible(true);
                    }}>
                        <Text style={categoriesStyles.addButtonText}> Nueva Categoria</Text>
                    </TouchableOpacity>
                </View>
            </View>
            {error?(
                        ...
                        <ScrollView>
                            ...
                            <View style={categoriesStyles.formContainer}>
                                <View style={categoriesStyles.inputGroup}>
                                    ...
                                    <TextInput style={categoriesStyles.input} value={formData.name}
